...
<template>
  <nav class="fixed top-0 bg-secondary/40 backdrop-blur-md px-4 w-full flex items-center justify-between h-14 border-b z-10">
    <SyllabyeLogo size="small" :slogan="false" class="motion-preset-slide-right-md"/>
