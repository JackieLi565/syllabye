...
const authUrl =
  config.public.googleAuth + "?redirect=" + config.public.googleRedirectUrl;
...
<template>
  <Dialog>
    <DialogTrigger as-child>
      <Button variant="default" class="text-xs md:text-sm"> Sign In </Button>
    </DialogTrigger>
    <DialogContent class="sm:max-w-[500px] px-4">
      ...
      <div class="space-y-2 py-5">
        <CardDescription
          >Sign in with your <b>torontomu.ca</b> email</CardDescription
        >
        <NuxtLink :to="authUrl">
